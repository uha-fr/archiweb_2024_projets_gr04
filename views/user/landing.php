            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="views/planning.php">Suivi</a></li>
                        <li class="nav-item"><a class="nav-link" href="#plannification">Planification</a></li>
                        <li class="nav-item"><a class="nav-link" href="#recettes">Recettes</a></li>
                        
                            <li class="nav-item sign-in-up"><a class="nav-link" href="views/user/register.php">Inscription</a></li>
                            <li class="nav-item sign-in-up"><a class="nav-link" href="views/user/login.php">Connexion</a></li>
